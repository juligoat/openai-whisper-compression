#!/usr/bin/env python
# Script to prune Whisper Small using global pruning and save using optimized compressed storage
...
def main():
    parser = argparse.ArgumentParser(
        description="Prune Whisper Small model using global pruning and save using optimized storage"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--model_name",
        type=str,
        default="whisper_small_global_pruned",
    ...
    # Step 4: Save model using optimized storage (kept the same from first file)
